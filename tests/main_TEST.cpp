...
int main()
{
   ...
   record_replay::test::instrumentation_test(
      "global_variable.cpp", "0", "-std=c++14",
   ...
   record_replay::test::instrumented_program_runs_through("global_variable.cpp", "0", "-std=c++14");

   record_replay::test::instrumentation_test(
      "global_struct_member.cpp", "0", "-std=c++14",
      {record_replay::test::wrapped_instruction_t{
   ...
   record_replay::test::instrumented_program_runs_through("global_struct_member.cpp", "0",
                                                          "-std=c++14");

   record_replay::test::instrumentation_test(
      "shared_variable_reference.cpp", "0", "-std=c++14",
      {record_replay::test::wrapped_instruction_t{
   ...
   record_replay::test::instrumented_program_runs_through("shared_variable_reference.cpp", "0",
                                                          "-std=c++14");

   record_replay::test::instrumentation_test(
      "function_static_variable_initialization.cpp", "0", "-std=c++14",
      {
   ...
   record_replay::test::instrumentation_test(
      "function_static_variable.cpp", "0", "-std=c++14",
      {record_replay::test::wrapped_instruction_t{
         "call void @wrapper_post_memory_instruction(i32 1, i8* bitcast (i32* "
   ...
   record_replay::test::instrumented_program_runs_through("function_static_variable.cpp", "0",
                                                          "-std=c++14");

   record_replay::test::instrumentation_test(
      "pthread_join_get_pointer_to_global_variable.cpp", "0", "-std=c++14",
      {record_replay::test::wrapped_instruction_t{
   ...
   record_replay::test::instrumented_program_runs_through("real_world/filesystem.c", "0", "");

   record_replay::test::instrumented_program_runs_through("real_world/dining_philosophers.c", "0",
                                                          "");

   record_replay::test::instrumented_program_runs_through("real_world/dining_philosophers.cpp", "0",
                                                          "-std=c++14");

   record_replay::test::instrumented_program_runs_through("real_world/work_stealing_queue.cpp", "0",
                                                          "-std=c++14");
